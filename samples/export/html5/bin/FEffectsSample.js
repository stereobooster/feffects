...
var Main = function() {
	...
	while(i < effects.length) {
		sprite = new browser.display.MovieClip();
		sprite.set_x(i * 10 + 30);
		gfx = sprite.get_graphics();
		gfx.beginFill(0,1);
		nme.Lib.get_current().addChild(sprite);
		gfx.lineTo(10,0);
		gfx.lineTo(10,10);
		gfx.lineTo(0,10);
		gfx.lineTo(0,0);
		gfx.endFill();
		t = feffects.TweenObject.tween(sprite,{ y : 150},2000,effects[i]);
		t.start();
		t.seek(350);
	...
	haxe.Log.trace("start for 2000ms tweening",{ fileName : "Main.hx", lineNumber : 112, className : "Main", methodName : "new"});
	haxe.Log.trace("seek at 350ms",{ fileName : "Main.hx", lineNumber : 113, className : "Main", methodName : "new"});
	haxe.Timer.delay(function() {
		haxe.Log.trace("pause",{ fileName : "Main.hx", lineNumber : 114, className : "Main", methodName : "new"});
	},250);
	haxe.Timer.delay(function() {
		haxe.Log.trace("resume",{ fileName : "Main.hx", lineNumber : 115, className : "Main", methodName : "new"});
	},500);
	haxe.Timer.delay(function() {
		haxe.Log.trace("reverse",{ fileName : "Main.hx", lineNumber : 116, className : "Main", methodName : "new"});
	},750);
	haxe.Timer.delay(function() {
		haxe.Log.trace("reverse",{ fileName : "Main.hx", lineNumber : 117, className : "Main", methodName : "new"});
	},1000);
	haxe.Timer.delay(function() {
		haxe.Log.trace("reverse",{ fileName : "Main.hx", lineNumber : 118, className : "Main", methodName : "new"});
	},1250);
	haxe.Timer.delay(function() {
		haxe.Log.trace("reverse",{ fileName : "Main.hx", lineNumber : 119, className : "Main", methodName : "new"});
	},1500);
	haxe.Timer.delay(function() {
		haxe.Log.trace("pause",{ fileName : "Main.hx", lineNumber : 120, className : "Main", methodName : "new"});
	},1750);
	haxe.Timer.delay(function() {
		haxe.Log.trace("resume",{ fileName : "Main.hx", lineNumber : 121, className : "Main", methodName : "new"});
	},2000);
};
$hxClasses["Main"] = Main;
Main.__name__ = ["Main"];
...
$hxClasses["feffects.TweenObject"] = feffects.TweenObject;
...
$hxClasses["feffects.Tween"] = feffects.Tween;
feffects.Tween.__name__ = ["feffects","Tween"];
feffects.Tween.addTween = function(tween) {
	if(!feffects.Tween._isTweening) {
		nme.Lib.get_current().get_stage().addEventListener(browser.events.Event.ENTER_FRAME,feffects.Tween.cb_tick);
...
feffects.Tween.checkActiveTweens = function() {
	if(feffects.Tween._aTweens.head == null) {
		nme.Lib.get_current().get_stage().removeEventListener(browser.events.Event.ENTER_FRAME,feffects.Tween.cb_tick);
...
feffects.Tween.cb_tick = function(_) {
...
feffects.TweenProperty = function(target,prop,value,duration,easing,autostart,onFinish) {
	...
	this.target = target;
	this.property = prop;
	if(js.Boot.__instanceof(target,browser.display.DisplayObject)) {
		this._doTarget = target;
		feffects.Tween.call(this,Reflect.getProperty(target,this.property),value,duration,easing,autostart,(function($this) {
			var $r;
			switch(prop) {
			case "x":
				$r = $bind($this,$this.__onUpdateX);
				break;
			case "y":
				$r = $bind($this,$this.__onUpdateY);
				break;
			case "width":
				$r = $bind($this,$this.__onUpdateWidth);
				break;
			case "height":
				$r = $bind($this,$this.__onUpdateHeight);
				break;
			case "alpha":
				$r = $bind($this,$this.__onUpdateAlpha);
				break;
			case "rotation":
				$r = $bind($this,$this.__onUpdateRotation);
				break;
			case "scaleX":
				$r = $bind($this,$this.__onUpdateScaleX);
				break;
			case "scaleY":
				$r = $bind($this,$this.__onUpdateScaleY);
				break;
			default:
				$r = $bind($this,$this.__onUpdate);
			}
			return $r;
		}(this)),onFinish);
	} else feffects.Tween.call(this,Reflect.getProperty(target,this.property),value,duration,easing,autostart,$bind(this,this.__onUpdate),onFinish);
};
$hxClasses["feffects.TweenProperty"] = feffects.TweenProperty;
...
feffects.TweenProperty.prototype = $extend(feffects.Tween.prototype,{
	__onUpdateScaleY: function(n) {
		this._doTarget.set_scaleY(n);
	}
	,__onUpdateScaleX: function(n) {
		this._doTarget.set_scaleX(n);
	}
	,__onUpdateRotation: function(n) {
		this._doTarget.set_rotation(n);
	}
	,__onUpdateAlpha: function(n) {
		this._doTarget.alpha = n;
	}
	,__onUpdateHeight: function(n) {
		this._doTarget.set_height(n);
	}
	,__onUpdateWidth: function(n) {
		this._doTarget.set_width(n);
	}
	,__onUpdateY: function(n) {
		this._doTarget.set_y(n);
	}
	,__onUpdateX: function(n) {
		this._doTarget.set_x(n);
	}
...
$hxClasses["feffects.easing.Back"] = feffects.easing.Back;
...
$hxClasses["feffects.easing.Bounce"] = feffects.easing.Bounce;
...
$hxClasses["feffects.easing.Circ"] = feffects.easing.Circ;
feffects.easing.Circ.__name__ = ["feffects","easing","Circ"];
...
$hxClasses["feffects.easing.Cubic"] = feffects.easing.Cubic;
...
$hxClasses["feffects.easing.Elastic"] = feffects.easing.Elastic;
...
$hxClasses["feffects.easing.Expo"] = feffects.easing.Expo;
...
$hxClasses["feffects.easing.Linear"] = feffects.easing.Linear;
...
$hxClasses["feffects.easing.Quad"] = feffects.easing.Quad;
...
$hxClasses["feffects.easing.Quart"] = feffects.easing.Quart;
...
$hxClasses["feffects.easing.Quint"] = feffects.easing.Quint;
...
$hxClasses["feffects.easing.Sine"] = feffects.easing.Sine;
